    ...
    if($UseAppTracking){
        ...
        if($returnedApps.data.ItemCount -eq 1){        
            ...
            if(-not $returnedApps.data.row.ows_Application_x0020_Package_x0020_) {
                Write-Error "Application Package type not defined in sharepoint application tracking."
                ...
                if(Get-CMApplication -Name $ApplicationTitle){
                    ...
                    if($ApplicationType -eq "APP-V"){
                        ...
                        if(Test-Path $AppVInstallerPath){
                            ...
                            Add-CMDeploymentType -ApplicationName $ApplicationTitle -AppvInstaller -InstallationFileLocation $appVfile -AutoIdentifyFromInstallationFile -ForceForUnknownPublisher $true -DeploymentTypeName "$ApplicationTitle App-V 4.6 Deployment" 
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        if($DeploymentInstallUseEnhanced){
                        ...
                        } #end use enhanced deployment type

...
#get resourceID from hostname
$machine = gwmi -Namespace root\sms\site_DLX -query "SELECT resourceID FROM SMS_R_SYSTEM WHERE name ='$HostName'" -ComputerName $SiteServer
